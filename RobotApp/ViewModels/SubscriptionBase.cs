...
namespace RobotApp.ViewModels
{
    ...
    /// </summary>
    public class SubscriptionBase : NavigableViewModelBase, ISubscription, INotifyDataErrorInfo
    {
